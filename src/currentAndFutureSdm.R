...
# this downloads 19 raster files, one for each variable
...
# let's create a raster stacj (stoack of layers/variables)
# list of files
...
#plot the points w/ Habronattus americanus
...
#set of rules to randomize for audience. everyone's model will be the same
...
#create a single data frame of data presence/absence data by climate variable
...
#naje a raster layer for the map, combining everything
habronattusPredictPlot <- raster::predict(habronattusCurrentSDM, geographicArea) 


# create spatial pizels data frame
